...
2. Fundamentos
   1. [Variables](./complementario/02-fundamentos/01-variables.md)
   2. [Tipos de datos](./complementario/02-fundamentos/02-tipos-de-datos.md)
   3. [Coercion de datos](./complementario/02-fundamentos/03-coercion-de-datos.md)
   4. [Operadores](./complementario/02-fundamentos/04-operadores.md)
   5. [Ejercicios](./complementario/02-fundamentos/05-ejercicios.md)
3. Estructuras de control
   1. [Condicionales](./complementario/03-estructuras-de-control/01-condicionales.md)
   2. [Bucles](./complementario/03-estructuras-de-control/02-bucles.md)
   3. [Ejercicios](./complementario/03-estructuras-de-control/03-ejercicios.md)
4. Funciones
   1. [Funciones](./complementario/04-funciones/01-funciones.md)
   2. [Ejercicios](./complementario/04-funciones/02-ejercicios.md)
5. Arrays
   1. [Arrays](./complementario/05-arrays/01-arrays.md)
   2. [Agregar y eliminar elementos](./complementario/05-arrays/02-agregar-y-eliminar-elementos.md)
   3. [Iterando arrays](./complementario/05-arrays/03-iterando-arrays.md)
   4. [Arrow functions](./complementario/05-arrays/04-arrow-functions.md)
   5. [Arrow functions con arrays](./complementario/05-arrays/05-arrow-functions-con-arrays.md)
   6. [Ejercicios](./complementario/05-arrays/06-ejercicios.md)
6. Objetos y clases
   1. [EcmaScript 6](./complementario/06-objetos-y-clases/01-ecmascript-6.md)
   2. [Declaración con let y const](./complementario/06-objetos-y-clases/02-declaracion-con-let-y-const.md)
   3. [String templates](./complementario/06-objetos-y-clases/03-string-templates.md)
   4. [Objetos](./complementario/06-objetos-y-clases/04-objetos.md)
   5. [Iterando objetos](./complementario/06-objetos-y-clases/05-iterando-objetos.md)
   6. [Desestructuración de objetos](./complementario/06-objetos-y-clases/06-desestructuracion-de-objetos.md)
   7. [Desestructuración de arrays](./complementario/06-objetos-y-clases/07-desestructuracion-de-arrays.md)
   8. [Clases](./complementario/06-objetos-y-clases/08-clases.md)
   9. [Ejercicios](./complementario/06-objetos-y-clases/09-ejercicios.md)
7. Programación orientada a objetos
   1. [Programación orientada a objetos](./complementario/07-poo/01-programacion-orientada-a-objetos.md)
   2. [Declaración de clases](./complementario/07-poo/02-declaracion-de-clases.md)
   3. [Abstract classes](./complementario/07-poo/03-abstract-classes.md)
   4. [Herencia](./complementario/07-poo/04-herencia.md)
   5. [Encapsulamiento](./complementario/07-poo/05-encapsulamiento.md)
   6. [Polimorfismo](./complementario/07-poo/06-polimorfismo.md)
   7. [Ejercicios](./complementario/07-poo/07-ejercicios.md)
8. DOM y eventos
   1. [DOM](./complementario/08-dom/01-dom.md)
   2. [Eventos](./complementario/08-dom/02-eventos.md)
   3. [Selección del DOM](./complementario/08-dom/03-seleccion-del-dom.md)
   4. [Crear elementos](./complementario/08-dom/04-crear-elementos.md)
   5. [Eventos del dom](./complementario/08-dom/05-eventos-del-dom.md)
   6. [Agregar eventos a elementos](./complementario/08-dom/06-agregar-eventos-a-elementos.md)
   7. [Manipulación de atributos](./complementario/08-dom/07-manipulacion-de-atributos.md)
   8. [LocalStorage](./complementario/08-dom/08-localstorage.md)
   9. [Elementos dinámicos](./complementario/08-dom/09-elementos-dinamicos.md)
   10. [Ejercicios](./complementario/08-dom/10-ejercicios.md)
9. Proyectos
   1. [Conversor de monedas](./complementario/proyectos/conversor-monedas.md)
